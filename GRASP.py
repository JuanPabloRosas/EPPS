...
f = open(folder + 'soluciones/SolucionesGRASP/GRASP.csv' , "w")
g = open(folder + 'soluciones/SolucionesGRASP/soluciones_GRASP.csv' , "w")
         ...
         for filename in os.listdir(folder + 'instancias\\'):
            if filename.endswith(".csv"):
               ...
               for k in range(kmin,101,5):
                  ...
                  print("CAND: "+ str(cand) + "  IT GRASP: " + str(iteraciones) +"  CI: " + str(CI) + "  KMIN: " + str(k) + "  RUNTIME: " + str(runtime) + "  SOL FINAL: " + str(valor_obj(sol_final)))
